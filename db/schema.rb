...
ActiveRecord::Schema[7.1].define(version: 2023_11_19_145902) do
  ...
  add_foreign_key "group_purchases", "groups", on_delete: :cascade
  add_foreign_key "group_purchases", "purchases", on_delete: :cascade
